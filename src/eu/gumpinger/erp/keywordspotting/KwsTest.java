...
public class KwsTest {
	...
	private String audioconfigfile = "16k_config_audio_voxde.xml";
	private String mfccconfigfile = "16k_config_mfcc_wsj.xml";
	private String urlToAudioFile = "file:./resources/test.wav";
	private String urlToMfccFile = "file:./resources/1.mfcc";
	
	private String[] keyword = {"conflict","organization","medical","george","patient","children","relationship","peace","knife","weapon"};
	
	boolean evaluation=false;
	private int[]	ss0={285,322,328,443,459,509,588,621,717,727};
	private int[]	ss1={414,424,476,489,542,615,618,689};
	private int[]	ss2={47,199,201,522};
	private int[]	ss3={243,244,250,257,295,320,478};
	private int[]	ss4={168,255,538,};
	private int[]	ss5={79,108,133};
	private int[]	ss6={263,403};
	private int[]	ss7={};
	private int[]	ss8={};
	private int[]	ss9={};
	/*
	...
	private final static Logger LOGGER = Logger.getLogger(KwsTest.class
			.getName());
	...
	private void prepareMfccRecognizer(){
		...
		ConfigurationManager cm = new ConfigurationManager(mfccconfigfile);
		recognizer = (Recognizer) cm.lookup("recognizer");
		grammar = (NoSkipGrammar) cm.lookup("NoSkipGrammar");
